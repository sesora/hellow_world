  ...
  return (
    <React.Fragment>
      ...
      <div>
        ...
        <Button_shadow label="buttonだよ！"></Button_shadow>
      </div>
      <Rotate>&lt; 💅 ">">&gt;</Rotate>
      <Button><Link to="/">戻る</Link></Button>
      <div>
        <H1_Underline color="pink">アンダーライン</H1_Underline>
        <H1_UnderlineDouble color="blue">下線 (二重線)</H1_UnderlineDouble>
        <H1_UnderlineTwotone color="green">下線 (2トーンカラー)</H1_UnderlineTwotone>
        <H1_marker color="orange">下線 (マーカー)</H1_marker>
        <H1_VerticalLine color="purple">マーク (縦ライン)</H1_VerticalLine>
        <P_underLine_anime color="silver">アンダーライン(アニメ)</P_underLine_anime>
      </div>
      <StyleList></StyleList>
...
const H1_UnderlineTwotone = styled.h1`
  position: relative;
  color: ${props => props.color ? props.color : 'black'};
  padding-bottom: 0.5em;
...
const P_underLine_anime = styled.p`
  color: ${props => props.color ? props.color : 'black'};
  position: relative;
  display: inline-block;
  font-size: 2em;
...
const Button_shadow = (props) => {
  const A_button = styled.a`
    display: block;
    cursor: pointer;
    width: 300px;
    /* margin: 0 auto; */
